...
public class MultipleAddressBook {  //different address book
	...
	public static void main(String[] args) {
		...
		Hashtable<Integer,AddressBookMain>  multipleAddressBook = new Hashtable<Integer, AddressBookMain>();  //dictionary for mapping different address book with key 
		...
		while(counter!=1) //it repeats till the user wants to end
		{
			...
			if(choice==6)  //to create a new address book
			{
				...
				multipleAddressBook.put(k, object1);
				k++;	
			}
